...
CREATE TABLE "public"."accomplishments" (
    ...
    CONSTRAINT "accomplishments_description_check" CHECK (("char_length"("description") > 0))
);
...
--
-- Name: accomplishments_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE "public"."accomplishments" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."accomplishments_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."accomplishments"
    ADD CONSTRAINT "accomplishments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
--
-- Name: accomplishments Individuals can create accomplishments.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Individuals can create accomplishments." ON "public"."accomplishments" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: accomplishments Individuals can delete their own accomplishments.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Individuals can delete their own accomplishments." ON "public"."accomplishments" FOR DELETE USING (("auth"."uid"() = "user_id"));


--
-- Name: accomplishments Individuals can update their own accomplishments.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Individuals can update their own accomplishments." ON "public"."accomplishments" FOR UPDATE USING (("auth"."uid"() = "user_id"));


--
-- Name: accomplishments Individuals can view their own accomplishments. ; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Individuals can view their own accomplishments. " ON "public"."accomplishments" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
--
-- Name: accomplishments; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "accomplishments"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "accomplishments_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."accomplishments_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."accomplishments_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."accomplishments_id_seq" TO "service_role";
